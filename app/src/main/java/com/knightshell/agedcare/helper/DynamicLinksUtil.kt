...
object DynamicLinksUtil {
    ...
    fun generateContentLink(): Uri {
        ...
        val link = FirebaseDynamicLinks.getInstance()
                ...
                .setIosParameters(DynamicLink.IosParameters.Builder("com.knightshell.agedcare").build())
                .setAndroidParameters(DynamicLink.AndroidParameters.Builder("com.knightshell.agedcare").build())
                .buildDynamicLink()
