...
import com.knightshell.agedcare.adapter.WeightGraphAdapter
...
class WeightGraphFragment : Fragment() {
    ...
    lateinit var adapter: WeightGraphAdapter
    lateinit var lineChart: LineChart

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {

        val view: View = inflater.inflate(R.layout.fragment_weight_graph, container, false)
        ...
        val listDatabase = databaseHandler!!.queryAllWeight()
        adapter = WeightGraphAdapter(listDatabase)
...
//        yAxis.setAxisMaximum(300.0f);
    ...
    private fun setData(){
        ...
        val Entries: java.util.ArrayList<Entry> = databaseHandler.weightXData()

        val set1 = LineDataSet(Entries, "Weight")
