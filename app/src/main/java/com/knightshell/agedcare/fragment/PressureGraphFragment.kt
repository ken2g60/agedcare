...
import com.knightshell.agedcare.adapter.PressureGraphAdapter
...
class PressureGraphFragment : Fragment() {

    lateinit var adapter: PressureGraphAdapter
    lateinit var lineChart: LineChart

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {

        val view: View = inflater.inflate(R.layout.fragment_pressure_graph, container, false)
        ...
        val listDatabase = databaseHandler!!.queryAllPressure()
        adapter = PressureGraphAdapter(listDatabase)
...
//        yAxis.setAxisMaximum(300.0f);
    ...
    private fun setData(){
        ...
        val Entries: ArrayList<Entry> = databaseHandler.pressureXData()

        val set1 = LineDataSet(Entries, "Pressure")
